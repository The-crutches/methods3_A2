...
model <- lmer(CHI_MLU ~ I(Visit^2)+ Visit*Diagnosis + (1+I(Visit^2)|Child.ID), train_data, REML=F)
...
k = 6
folds = createFolds(unique(train_data$SUBJ), k = k, list = TRUE, returnTrain = FALSE)
