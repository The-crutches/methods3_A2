...
our_vs_simple <- select(our_vs_simple, diff_simple, diff_our, folds) #selecting relevant data
diff_df <- gather(our_vs_simple, difference, value, diff_our, diff_simple, factor_key = T) #changing data format to long
