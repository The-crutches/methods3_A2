...
#Dataframe
our_vs_simple <- data.frame(trainRMSE_our, testRMSE_our, diff_max, trainRMSE_simple, testRMSE_simple, diff_simple)
  #Fold column
our_vs_simple$folds <- c(1:6)

#Plotting our model against the simple model
our_vs_simple$folds <- as.factor(our_vs_simple$folds)
our_vs_simple <- select(our_vs_simple, diff_simple, diff_max, folds) #selecting relevant data
diff_df <- gather(our_vs_simple, difference, value, diff_max, diff_simple, factor_key = T) #changing data format to long
